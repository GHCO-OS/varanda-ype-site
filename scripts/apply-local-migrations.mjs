...
for (const file of ['migrations/0001_delivery_tracking.sql', 'migrations/0002_leads_capture.sql', 'migrations/0003_marketing_attribution.sql']) database.exec(fs.readFileSync(file, 'utf8'));
